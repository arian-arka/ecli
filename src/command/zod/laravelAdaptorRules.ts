...
export const rulesConvertors = {
    ...
    'array'(key: string) {
        return `array({required_error : ${templates.message(key, 'required')}, invalid_type_error : ${templates.message(key, 'array')} })`
    },
    'object'(key: string) {
        return `object({required_error : ${templates.message(key, 'required')}, invalid_type_error : ${templates.message(key, 'object')} })`
    },
    'integer'(key: string) {
