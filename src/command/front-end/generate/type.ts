...
export default class laravel extends Command {
    @terminal({
        description: 'Generating types in Typescript from laravel apis',
        paras: {}
    })

    @validateProps<Parameters<InstanceType<typeof laravel>['index']>[0]>({
        type: "object",
        properties: {},
        required: [],
    ...
    async rakutentechRequestDocs(args: {
        uri?: string,
